...
if (config.WORKTYPE == 'private') {
    ...
    XTroid.addCMD({pattern: 'video ?(.*)', fromMe: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
        ...
        yt.on('end', async () => {
            ...
            await message.client.sendMessage(message.jid,fs.readFileSync('./' + VID + '.mp4'), MessageType.video, {mimetype: Mimetype.mp4,caption:'© x-ᴛʀᴏɪᴅ ɴɪᴍᴀ ᴇᴅɪᴛɪᴏɴ',quoted: message.data});
        });
    }));
