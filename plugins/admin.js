...
XTroid.addCMD({pattern: 'ban ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.BAN_DESC}, (async (message, match) => {  
...
XTroid.addCMD({pattern: 'add(?: |$)(.*)', fromMe: true, onlyGroup: false, desc: Lang.ADD_DESC}, (async (message, match) => {  
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
XTroid.addCMD({pattern: 'promote ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.PROMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
XTroid.addCMD({pattern: 'demote ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.DEMOTE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
...
XTroid.addCMD({pattern: 'invite ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.INVITE_DESC}, (async (message, match) => {    
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
